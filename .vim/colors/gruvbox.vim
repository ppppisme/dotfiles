...
if version >= 703
	...
	call s:HL('CursorLineNr', 'yellow', 'dark1', 'bold')
endif
...
call s:HL('Todo', 'red', 'bg', 'bold')
call s:HL('Error', 'bg', 'red', 'bold')

" Generic statement
call s:HL('Statement',   'red', 'none', "italic")
" if, then, else, endif, swicth, etc.
call s:HL('Conditional', 'red', 'none', "italic")
" for, do, while, etc.
call s:HL('Repeat',      'red', 'none', "italic")
" case, default, etc.
call s:HL('Label',       'red', 'none', "italic")
" try, catch, throw
call s:HL('Exception',   'red', 'none', "italic")
" sizeof, "+", "*", etc.
