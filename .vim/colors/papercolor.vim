...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  call s:HL("StatusLine", s:statusline_active_fg, s:statusline_active_bg, "")
  ...
  call s:HL("vimCommentTitle", s:comment, "", "")
  call s:HL("vimBracket", s:aqua, "", "")
  call s:HL("vimParenSep", s:aqua, "", "")
  call s:HL("vimSynType", s:olive, "", "")
  ...
  call s:HL("makeStatement", s:aqua, "", "")
  call s:HL("makeCommands", s:foreground, "", "")
  call s:HL("makeSpecial", s:orange, "", "")
  ...
  " call s:HL("cAnsiFunction",s:aqua, "", "")
  ...
  " call s:HL("cTodo", s:comment, "", "")
  " call s:HL("cStructure", s:blue, "", "")
  call s:HL("cCustomParen", s:foreground, "", "")
  " call s:HL("cCustomFunc", s:foreground, "", "")
  " call s:HL("cUserFunction",s:blue, "", "")
  call s:HL("cOctalZero", s:purple, "", "")
  ...
  call s:HL("cppSTLfunctional", s:foreground, "", "")
  call s:HL("cppSTLiterator", s:foreground, "", "")
  " call s:HL("cppSTLfunction", s:aqua, "", "")
  call s:HL("cppExceptions", s:red, "", "")
  call s:HL("cppStatement", s:blue, "", "")
  call s:HL("cppStorageClass", s:navy, "", "")
  ...
  " call s:HL("lexPatBlock", s:foreground, "", "")
  call s:HL("lexSlashQuote", s:foreground, "", "")
  call s:HL("lexSep", s:foreground, "", "")
  call s:HL("lexStartState", s:orange, "", "")
  call s:HL("lexPatTagZone", s:olive, "", "")
  call s:HL("lexMorePat", s:olive, "", "")
  call s:HL("lexOptions", s:olive, "", "")
  ...
  call s:HL("nasmDirective", s:blue, "", "")
  call s:HL("nasmLocalLabel", s:orange, "", "")

  " GAS highlighting
  call s:HL("gasSymbol", s:pink, "", "")
  call s:HL("gasDirective", s:blue, "", "")
  ...
  call s:HL("gasDirectiveStore", s:foreground, "", "")

  " MIPS highlighting
  call s:HL("mipsInstruction", s:pink, "", "")
  call s:HL("mipsRegister", s:navy, "", "")
  call s:HL("mipsLabel", s:aqua, "", "")
  call s:HL("mipsDirective", s:purple, "", "")

  " Shell/Bash highlighting
  call s:HL("bashStatement", s:foreground, "", "")
  call s:HL("shDerefVar", s:aqua, "", "")
  call s:HL("shDerefSimple", s:aqua, "", "")
  call s:HL("shFunction", s:orange, "", "")
  call s:HL("shStatement", s:foreground, "", "")
  call s:HL("shLoop", s:purple, "", "")
  call s:HL("shQuote", s:olive, "", "")
  call s:HL("shCaseEsac", s:aqua, "", "")
  ...
  " HTML Highlighting
  call s:HL("htmlTitle", s:green, "", "")
  call s:HL("htmlH1", s:green, "", "")
  call s:HL("htmlH2", s:aqua, "", "")
  call s:HL("htmlH3", s:purple, "", "")
  call s:HL("htmlH4", s:orange, "", "")
  ...
  call s:HL("htmlItalic", s:comment, "", "")
  call s:HL("htmlBoldItalic", s:navy, "", "")
  " call s:HL("htmlLink", s:blue, "", "")
  call s:HL("htmlTagN", s:pink, "", "")
  call s:HL("htmlSpecialTagName", s:orange, "", "")
  call s:HL("htmlComment", s:comment, "", "")
  call s:HL("htmlCommentPart", s:comment, "", "")

  " Markdown Highlighting
  call s:HL("markdownH1", s:pink, "", "")
  call s:HL("markdownBlockquote", s:pink, "", "")
  call s:HL("markdownCodeBlock", s:purple, "", "")
  call s:HL("markdownLink", s:blue, "", "")
  call s:HL("mkdCode", s:olive, "", "none")
  call s:HL("mkdLink", s:blue, "", "")
  ...
  call s:HL("javaClassDecl", s:aqua, "", "")
  call s:HL("javaScopeDecl", s:blue, "", "")
  call s:HL("javaStorageClass", s:navy, "", "")
  call s:HL("javaBoolean", s:navy, "", "")

  " JavaScript Highlighting
  call s:HL("javaScriptBraces", s:blue, "", "")
  call s:HL("javaScriptParens", s:blue, "", "")
  call s:HL("javaScriptIdentifier", s:navy, "", "")
  call s:HL("javaScriptFunction", s:pink, "", "")
  call s:HL("javaScriptConditional", s:purple, "", "")
  call s:HL("javaScriptRepeat", s:purple, "", "")
  ...
  call s:HL("plantumlClassPublic", s:olive, "", "")
  ...
  call s:HL("plantumlTypeKeyword", s:blue, "", "")
  call s:HL("plantumlKeyword", s:pink, "", "")

  call s:HL("plantumlType", s:blue, "", "")
  call s:HL("plantumlBlock", s:pink, "", "")
  call s:HL("plantumlPreposition", s:orange, "", "")
  call s:HL("plantumlLayout", s:blue, "", "")
  call s:HL("plantumlNote", s:orange, "", "")
  call s:HL("plantumlLifecycle", s:aqua, "", "")
  call s:HL("plantumlParticipant", s:foreground, "", "")


  " Haskell Highlighting
  call s:HL("haskellType", s:aqua, "", "")
  call s:HL("haskellIdentifier", s:orange, "", "")
  call s:HL("haskellOperators", s:pink, "", "")
  call s:HL("haskellWhere", s:foreground, "", "")
  call s:HL("haskellDelimiter", s:aqua, "", "")
  call s:HL("haskellImportKeywords", s:pink, "", "")
  call s:HL("haskellStatement", s:purple, "", "")


  " SQL/MySQL Highlighting
  call s:HL("sqlStatement", s:pink, "", "")
  call s:HL("sqlType", s:blue, "", "")
  call s:HL("sqlKeyword", s:pink, "", "")
  call s:HL("sqlOperator", s:aqua, "", "")
  call s:HL("sqlSpecial", s:green, "", "")

  call s:HL("mysqlVariable", s:olive, "", "")
  call s:HL("mysqlType", s:blue, "", "")
  call s:HL("mysqlKeyword", s:pink, "", "")
  call s:HL("mysqlOperator", s:aqua, "", "")
  call s:HL("mysqlSpecial", s:green, "", "")
  ...
  call s:HL("octaveBeginKeyword", s:purple, "", "")
  call s:HL("octaveElseKeyword", s:purple, "", "")
  call s:HL("octaveEndKeyword", s:purple, "", "")
  call s:HL("octaveStatement", s:pink, "", "")

  " Ruby Highlighting
  call s:HL("rubyModule", s:navy, "", "")
  call s:HL("rubyClass", s:pink, "", "")
  call s:HL("rubyPseudoVariable", s:comment, "", "")
  call s:HL("rubyKeyword", s:pink, "", "")
  call s:HL("rubyInstanceVariable", s:purple, "", "")
  call s:HL("rubyFunction", s:foreground, "", "")
  ...
  call s:HL("rubyConditional", s:purple, "", "")
  call s:HL("rubyRepeat", s:purple, "", "")
  call s:HL("rubyControl", s:purple, "", "")
  call s:HL("rubyException", s:purple, "", "")
  call s:HL("rubyExceptional", s:purple, "", "")
  call s:HL("rubyBoolean", s:green, "", "")

  " Fortran Highlighting
  call s:HL("fortranUnitHeader", s:foreground, "", "")
  call s:HL("fortranType", s:pink, "", "")
  call s:HL("fortranStructure", s:blue, "", "")
  call s:HL("fortranStorageClass", s:navy, "", "")
  call s:HL("fortranStorageClassR", s:navy, "", "")
  ...
  call s:HL("phpRepeat", s:purple, "", "")
  call s:HL("phpConditional", s:purple, "", "")
  call s:HL("phpStatement", s:pink, "", "")
  call s:HL("phpAssignByRef", s:aqua, "", "")
  call s:HL("phpSpecialFunction", s:blue, "", "")
  call s:HL("phpFunctions", s:blue, "", "")
  call s:HL("phpComparison", s:aqua, "", "")
  call s:HL("phpBackslashSequences", s:olive, "", "")
  call s:HL("phpMemberSelector", s:blue, "", "")
  call s:HL("phpStorageClass", s:purple, "", "")
  ...
  call s:HL("perlStatementInclude", s:aqua, "", "")
  call s:HL("perlStatementScalar", s:purple, "", "")
  call s:HL("perlSubName", s:aqua, "", "")
  call s:HL("perlSpecialString", s:olive, "", "")

  " Lua Highlighting
  call s:HL("luaFunc", s:foreground, "", "")
  call s:HL("luaIn", s:blue, "", "")
  call s:HL("luaFunction", s:pink, "", "")
  call s:HL("luaStatement", s:blue, "", "")
  call s:HL("luaRepeat", s:blue, "", "")
  call s:HL("luaCondStart", s:purple, "", "")
  call s:HL("luaTable", s:aqua, "", "")
  call s:HL("luaConstant", s:green, "", "")
  call s:HL("luaElse", s:purple, "", "")
  call s:HL("luaCondElseif", s:purple, "", "")
  call s:HL("luaCond", s:purple, "", "")
  ...
  call s:HL("ngxDirectiveBlock", s:pink, "", "")
  call s:HL("ngxDirective", s:blue, "", "none")
  call s:HL("ngxDirectiveImportant", s:blue, "", "")
  ...
  call s:HL("NERDTreeHelpTitle", s:blue, "", "")
  ...
  " Plugin: Tagbar
  call s:HL("TagbarHelpTitle", s:blue, "", "")
...
highlight CursorLineNr guifg=#3a9e91
