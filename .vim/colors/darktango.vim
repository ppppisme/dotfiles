...
hi Statement	guifg=#888a85	gui=none
hi Type		guifg=#ce5c00	gui=none
hi PreProc	guifg=#eeeeec 	gui=none
hi Constant	guifg=#babdb6	gui=none
hi Identifier	guifg=#ce5c00 	gui=none
hi Special	guifg=#eeeeec	gui=none
hi Ignore	guifg=#f57900	gui=none
hi Todo		guibg=#ce5c00 guifg=#eeeeec	gui=none
"hi Error
"}}}
...
hi CursorLineNr		guibg=#2e3436 guifg=#999999
